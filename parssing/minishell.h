...
/*   Updated: 2022/05/03 13:19:23 by tel-bouh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_case_two(char *c, int i, char *cmd);
...
// ft_display.c  display struct elements
...
char	*ft_join_home_path(t_mini *line, g_built *built);
int		ft_go_to_path(t_mini *line, g_built *builts);

// ft_cd_util_two.c
int		ft_file_out(t_mini *line);
void	ft_heredoc_util(char *g_line, char *lim);
int		ft_here_doc(t_mini *line);
int		ft_previous_dir(g_built *built);
int		ft_user_home(t_mini *line, g_built *built);

// ft_cd_util.c
int		ft_go_home(t_mini *line, g_built *built);
...
int		ft_cd(t_mini *line, g_built *buit);
...
int		ft_echo_util(t_mini *line, t_echo ech, g_built *built);

// ft_echo.c
char	*ft_echo_q(char *exp);
void	ft_echo_util_two(t_mini *line, t_echo echo, g_built *built);
